...
export const t = {
  vi: {
    ...
    modeZaloMiniApp: "Zalo Mini App",
    modeZaloMiniAppDesc: "App chạy trong Zalo — tải về .zip để submit Zalo Developers",
  ...
  en: {
    ...
    modeZaloMiniApp: "Zalo Mini App",
    modeZaloMiniAppDesc: "App running inside Zalo super-app — download .zip for Zalo Developers",
