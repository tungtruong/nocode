// POST /api/sheet/<appId>/update { rowNumber, fields }
// Owner-only sparse update of an existing row.
...
export async function POST(req: NextRequest, ctx: { params: Promise<{ id: string }> }) {
  ...
  let body: { rowNumber?: unknown; fields?: unknown };
  ...
  try {
    ...
    console.error("[sheet/update] failed:", msg);
    return NextResponse.json({ error: "Cập nhật sheet thất bại" }, { status: 502 });
  }
}
