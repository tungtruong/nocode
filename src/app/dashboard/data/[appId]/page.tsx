      ...
      <main className="max-w-6xl mx-auto px-6 py-6">
        <div className="mb-6">
          ...
          <p className="text-sm text-[#52525b] mt-1">
            App: <span className="font-mono">{appId.slice(0, 12)}…</span> · Dữ liệu app đọc qua
            <code className="mx-1 px-1.5 py-0.5 rounded bg-[#f5f3ff] text-[#7c3aed] text-xs">jv.db.list(&apos;...&apos;)</code>
          </p>
        </div>
